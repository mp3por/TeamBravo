...
REM
REM The Original Code is http_terrier.bat
REM
...
if defined TERRIER_HOME goto terrier_lib
CALL "%BIN%\fq.bat" "%BIN%\.."
SET TERRIER_HOME=%FQ%
...
if [%1]==[] (
	...
	%TERRIER_HOME%\bin\anyclass.bat org.terrier.utility.SimpleJettyHTTPServer %* 
)
