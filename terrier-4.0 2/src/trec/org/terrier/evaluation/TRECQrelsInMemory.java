...
public class TRECQrelsInMemory{
	protected static final Logger logger = Logger.getLogger(TRECQrelsInMemory.class);
	/** 
	...
	public TRECQrelsInMemory(){
		try {
			...
			logger.fatal("Problem loading relevance assessments from property trec.qrels :", ioe);
			return;
		}
	}
	/**
